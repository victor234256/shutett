...
const IndexPage = () => {
	...
	const handleShortUrl = (e) => {
		e.preventDefault();
		if (longUrl)
			navigate(`/authenticate?createNew=${longUrl}`);
	};
	return (
		<>
			<div className="flex flex-col items-center">
				<h2 className="text-gray-900 text-center text-3xl my-10 sm:my-16 sm:text-6xl lg:text-7xl font-extrabold dark:text-white">
					It&apos;s too long ? <br className="mb-2" /> Cut
					ett ✂
				</h2>
				<form
				...
				>
					...
					/>
					<Button
						className="min-h-14 text-1xl font-bold"
						type="submit"
					>
						Shorten it!
					</Button>
			...
			<div className="container mt-20 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-5">
				<Card className="bg-white dark:bg-opacity-0 rounded-lg px-4 py-6 ring-1 ring-slate-900/5 shadow-xl ">
					<CardHeader>
						...
						<CardDescription className="font-normal text-gray-700 dark:text-gray-400 text-lg">
							Shutett is easy and fast, enter the long link
							to get your shortened link
						</CardDescription>
					</CardHeader>
				</Card>
				...
				<Card className="bg-white dark:bg-opacity-0 rounded-lg px-4 py-6 ring-1 ring-slate-900/5 shadow-xl ">
					<CardHeader>
						...
						<CardDescription className="font-normal text-gray-700 dark:text-gray-400 text-lg">
							Shutett makes barcode creation effortless—just
							enter link data to generate a barcode
							instantly.
						</CardDescription>
					</CardHeader>
				</Card>
				<Card className="bg-white dark:bg-opacity-0 rounded-lg px-4 py-6 ring-1 ring-slate-900/5 shadow-xl">
					<CardHeader>
						...
						<CardDescription className="font-normal text-gray-700 dark:text-gray-400 text-lg">
							Shutett is easy and fast—enter your long link
							to get a shortened link quickly.
						</CardDescription>
					</CardHeader>
				</Card>
				<Card className="bg-white dark:bg-opacity-0 rounded-lg px-4 py-6 ring-1 ring-slate-900/5 shadow-xl">
					<CardHeader>
						...
						<CardDescription className="font-normal text-gray-700 dark:text-gray-400 text-lg">
							Shutett allows you to create a personalized
							short link for a custom URL.
						</CardDescription>
					</CardHeader>
				</Card>
				<Card className="bg-white dark:bg-opacity-0 rounded-lg px-4 py-6 ring-1 ring-slate-900/5 shadow-xl">
					<CardHeader>
						...
						<CardDescription className="font-normal text-gray-700 dark:text-gray-400 text-lg">
							...
							desktops for seamless use on any device.
						</CardDescription>
					</CardHeader>
				</Card>
				<Card className="bg-white dark:bg-opacity-0 rounded-lg px-4 py-6 ring-1 ring-slate-900/5 shadow-xl">
					<CardHeader>
						...
						<CardDescription className="font-normal text-gray-700 dark:text-gray-400 text-lg">
							It is fast and secure—our service uses HTTPS
							protocol and data encryption to protect your
							information.
						</CardDescription>
					</CardHeader>
				</Card>
